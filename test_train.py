...
data_file = open('data/json/merged.json').read()
...
hist = model.fit(np.array(train_x), np.array(train_y), epochs=550, batch_size=5, verbose=1)

model.save('chat_model/chatbot_save_model', hist)
print('Done')